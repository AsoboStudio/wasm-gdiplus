...
#define GDIP_EMFPLUS_RECORD_BASE (0x4000)
	...
	*/
	...
	typedef enum {
		...
		PathPointTypeBezier = 0x02,
		PathPointTypePathTypeMask = 0x04,
		PathPointTypeDashMode = 0x08,
		PathPointTypePathMarker = 0x10,
		PathPointTypeCloseSubpath = 0x20,
		PathPointTypeBezier3 = 0x02
	} PathPointType;
...
#endif
/*
static  BOOL ObjectTypeIsValid(ObjectType type)
{
	switch (type) {
